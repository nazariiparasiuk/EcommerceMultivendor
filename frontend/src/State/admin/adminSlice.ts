...
import { HomeCategory, HomeCategoryRequest } from '../../types/homeCategoryTypes';

const API_URL = '/admin';

export const updateHomeCategory = createAsyncThunk<HomeCategory, { id: number; data: HomeCategoryRequest }>(
